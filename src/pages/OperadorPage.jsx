  ...
  return (
    <div style={s.page}>
      ...
      <main style={s.main}>
        ...
        <p style={s.sub}>Bienvenido al panel de operador — página en construcción</p>
      </main>
    </div>
  )
}
...
const s = {
  ...
  avatar:     { width: '32px', height: '32px', borderRadius: '50%', background: 'linear-gradient(135deg,#1e3a5f,#2e75b6)', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 700, fontSize: '0.85rem' },
